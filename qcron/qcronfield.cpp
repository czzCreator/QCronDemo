...
QCronIntNode *
QCronField::
_parseInt(QString & str,int &testInt_val)
{
    int value = 0;
    int char_idx = 0;
...
_parseRange(QString & str)
{
    ...
    int justtest_int = -1;
    QCronIntNode * end = dynamic_cast<QCronIntNode *>(_parseInt(str,justtest_int));
    if (end == NULL)
    {
        throw QCronFieldException(QString("Syntax error: expected an interger at %1")
                                  .arg(str));
...
//    bool is_lastnode_validValue = false;
//    QCronIntNode * beginInt = nullptr;
//    QCronEveryNode * beginEvery = nullptr;

//    beginInt = dynamic_cast<QCronIntNode *>(_last_node);
//    if (beginInt != NULL)
//    {
//        is_lastnode_validValue = true;
//        int justtest_int = -1;

//        QCronIntNode * int_begin_v = _parseInt(str,justtest_int);

//        qDebug() << "czz check...... we  get  an  int  from  X/X  first,:-->" << justtest_int;
//    }
//    else
//    {
//        beginEvery = dynamic_cast<QCronEveryNode *>(_last_node);
//        if (beginEvery != NULL)
//        {
//            is_lastnode_validValue = true;
//            qDebug() << "czz check...... we  get  an  allMatch!  from  */X  first,";
//        }
//        else
//        {
...
//    }
    ...
    int justtest_int = -1;
    str.remove(0, 1);
    return new QCronEveryNode(_last_node, _parseInt(str,justtest_int));
}
...
_parseNode(QString & str)
{
    ...
    {
        int justtest_int = -1;
        node = _parseInt(str,justtest_int);
    }
    else if ('-' == c)
    {
